...
const App = () => {
  ...
  const deleteBtnClick = () => {
    const filtredProducts = itemsIsInCart.filter(id => id !== removeFromCartItemId)
 ...
 <>
      ...
      <Switch>
        ...
        <Route exact path="/cart">
          <Cart
            items={items} itemsIsInCart={itemsIsInCart} favorites={favorites}
            removeFromCartBtnClick={removeFromCartBtnClick}
            onCheckBtnClick={onCheckBtnClick} />

          {removeFromModalOpen && <Modal
        closeBtn = "btn-close btn-close-white" 
        isCloseBtn = {true} 
        ...
        <Route exact path="/favorites">
          <Favor
            ...
            addToCartBtnClick={addToCartBtnClick} onCheckBtnClick={onCheckBtnClick} />
