...
const Modal = (props) => {
  const {header, bgHeader, closeBtn, isCloseBtn, text, headerTextColor, bgBody, bodyTextColor,  actions, onClick} = props
  return (<>
    ...
    <div className="modal-backdrop" style = {{opacity: ".5"}} onClick ={onClick}></div>
    </>)
}
