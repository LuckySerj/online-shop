...
const ProductCard = ({ product, onAddClick, onRemoveClick, status }) => {
  ...
  const checked = favorites.some((item) => item === id);

  const onSelectBtnClick = () => {
    const favoriteProducts = [...favorites];
    dispatch(setFavoritesThunk(id, favoriteProducts));
  };
    ...
    <li className="card g-col-6 g-col-md-4 product-card">
      <div className="col">
          ...
          <Button
            ...
            text={
              <>
                ...
                <p className="text-white d-inline-block mb-0">Add</p>
              </>
            }
            bgColor="#fb4509"
        ...
        <svg
          ...
          fill={
            checked || status === "favorite" ? "#FFD700" : "rgb(158,149,149)"
          }
        >
